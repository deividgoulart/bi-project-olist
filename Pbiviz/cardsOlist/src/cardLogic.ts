...
export type CardVariant = "normal" | "atencao" | "destaque";
...
export function resolveCardVariant(raw: powerbi.PrimitiveValue): CardVariant {
    if (raw === "atencao" || raw === "destaque") return raw;
    return "normal";
}
