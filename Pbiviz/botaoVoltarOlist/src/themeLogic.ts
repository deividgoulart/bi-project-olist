...
// mesma lógica usada em tabelaOlist/barrasOlist/cabecalhoOlist — texto
// "dark"/"escuro" (sem acento/maiúscula) ou numérico 1 aciona o modo escuro;
// qualquer outra coisa (incluindo medida não vinculada) cai no modo claro
